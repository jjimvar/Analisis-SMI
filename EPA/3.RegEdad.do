...
replace adult=2 if inlist(edad5, 8,9,10,11) //Más de 50 años
...
***********************************Resultados***********************************
*Actividad
esttab act1 act2 empl1 empl2 using 3.RegEdad.rtf, keep(anoenc tratado did) ///
	title("Regresión: Resultado edad") ///
