...
label define ned 1 "Obligatorio" 2 "Posobligatorio"
label values neduc ned
...
***********************************Resultados***********************************
*Actividad
esttab act1 act2 empl1 empl2 using 3.RegEduc.rtf, keep(anoenc tratado did) ///
	title("Regresión: Resultado nivel educativo") ///
	mtitles("Obligatorio" "Posbligatorio" "Obligatorio" "Posobligatorio") ///
