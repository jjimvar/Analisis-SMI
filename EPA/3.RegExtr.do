...
foreach n in 1 0 {
	preserve
	*Filtramos la muestra por nacionalidad
	keep if extranjero==`n'
	...
	**Creamos la global
	...
	global b hombre i.edad5 i.educ
...
***********************************Resultados***********************************
*Actividad
esttab act1 act0 empl1 empl0 using 3.RegExtr.rtf, keep(anoenc tratado did) ///
	title("Regresión: Resultado nacionalidad") ///
	mtitles("Extranjero" "No extranjero" "Extranjero" "No extranjero") ///
