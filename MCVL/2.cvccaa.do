...
********************************************************************************
*Variables iteradas
global x1 hombre edad5 comunidad paisnac educ relab

global x2 i.hombre#(i.edad5 i.comunidad i.paisnac i.educ c.relab) i.edad5#(i.comunidad i.paisnac i.educ c.relab) i.comunidad#(i.paisnac i.educ c.relab) i.paisnac#(i.educ c.relab) i.educ#c.relab

lasso logit afecta ($x1) $x2  if train==1, selection(cv, gridminok) grid(80, ratio(1e-3)) stop(1e-3) tolerance(1e-5) 
