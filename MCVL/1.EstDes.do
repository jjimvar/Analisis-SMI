...
scalar N=r(N)
foreach n in 1 0{
	qui count if afecta == `n'
	scalar sum`n'=r(N)
	scalar por`n' = r(N)/N*100	
}
matrix afect=(sum1, por1 \ sum0, por0\ N, 100)
matrix rownames afect= "Afectado por SMI 2019" "No afectado" "Total"
matrix colnames afect= "N Obs" "Pct (%)"
